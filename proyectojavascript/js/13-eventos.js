...
let nombreApellido = prompt("Escriba su nombre", "Escriba aqui");
let nuevoTitulo = document.querySelector("h1");
nuevoTitulo.textContent = nombreApellido
...
/*
<section class="formularioEjercicio">
    (((DISEÑO CUESTIONARIO))) 
        <form>
