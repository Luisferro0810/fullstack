...
class COCHE {
    ...
    añosCoche() {
        ...
        console.log(`el coche tiene una edad de:${añoActual - this.AÑOCOMPRA} años desde que fue comprado`);
    }

}
const COCHE1 = new COCHE("audi", 2015, "Gasolina", 67890)
console.log(COCHE1)
const COCHE2 = new COCHE("toyota", 2010, "diesel", 12345)
console.log(COCHE2)
...
const ITV1 = new ITV("audi", 2015, "Gasolina", 67890, "15/09/2024")
console.log(ITV1)
